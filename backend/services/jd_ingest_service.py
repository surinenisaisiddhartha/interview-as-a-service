...
class JDIngestService:
    ...
    def run(
        ...
        Args:
            ...
            client_company: Optional client/custom company name to store with the job.
        ...
        try:
            ...
            log_tool.log_info("💼 JD ingested to DB: job id=%s company=%s client=%s" % (job.s3_job_id, company_name, client_company))
